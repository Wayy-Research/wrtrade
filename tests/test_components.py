...
class TestPortfolioComponentInterface:
    ...
    def test_signal_component_is_portfolio_component(
        self, sample_prices, ma_crossover_signal
    ):
        """Test that SignalComponent properly inherits from PortfolioComponent."""
        component = SignalComponent(
            name="test_component", signal_func=ma_crossover_signal, weight=1.0
        )
    ...
    def test_weight_management(self, sample_prices, ma_crossover_signal):
        ...
        initial_weight = 0.75
        component = SignalComponent(
            name="weight_test", signal_func=ma_crossover_signal, weight=initial_weight
        )
...
class TestSignalComponent:
    ...
    def test_basic_creation(self, ma_crossover_signal):
        ...
        component = SignalComponent(
            name="basic_test", signal_func=ma_crossover_signal, weight=1.0
        )
    ...
    def test_signal_generation(self, sample_prices, ma_crossover_signal):
        ...
        component = SignalComponent(
            name="signal_test", signal_func=ma_crossover_signal, weight=1.0
        )
        ...
        assert unique_signals.issubset(
            {-1, 0, 1}
        ), f"Unexpected signal values: {unique_signals}"
    ...
    def test_return_calculation(self, sample_prices, ma_crossover_signal):
        ...
        component = SignalComponent(
            name="return_test", signal_func=ma_crossover_signal, weight=1.0
        )
    ...
    def test_performance_metrics(self, sample_prices, ma_crossover_signal):
        ...
        component = SignalComponent(
            name="metrics_test", signal_func=ma_crossover_signal, weight=1.0
        )
    ...
    def test_weight_scaling(self, sample_prices, ma_crossover_signal):
        ...
        base_component = SignalComponent(
            name="base", signal_func=ma_crossover_signal, weight=1.0
        )

        scaled_component = SignalComponent(
            name="scaled", signal_func=ma_crossover_signal, weight=2.0
        )
        ...
        ratio = (
            scaled_returns.sum() / base_returns.sum() if base_returns.sum() != 0 else 0
        )
    ...
    def test_position_limits(self, sample_prices, buy_hold_signal):
        ...
        ), f"Position limit violated: {max_absolute_position} > {max_pos}"
    ...
    def test_different_signal_types(
        ...
        for name, signal_func in signals_config:
            component = SignalComponent(name=name, signal_func=signal_func, weight=1.0)
        ...
        for name, result in results.items():
            ...
            assert np.isfinite(
                result["volatility"]
            ), f"{name} has non-finite volatility"
...
class TestAllocationWeights:
    ...
    def test_normalization(self):
        ...
        weights = AllocationWeights(weights={"A": 0.8, "B": 1.2, "C": 0.6})  # Sum = 2.6
        ...
        assert (
            abs(original_ratio - normalized_ratio) < 1e-10
...
class TestSignalComponentIntegration:
    ...
    def test_multiple_components_correlation(self, long_sample_prices):
        ...
        for name, component in components.items():
            returns_data[name] = component.calculate_returns(
                long_sample_prices
            ).to_numpy()
    ...
    def test_edge_cases(self, ma_crossover_signal):
        ...
        component = SignalComponent(
            name="edge_test", signal_func=ma_crossover_signal, weight=1.0
        )
    ...
    def test_performance_consistency(self, sample_prices, ma_crossover_signal):
        ...
        component = SignalComponent(
            name="consistency_test", signal_func=ma_crossover_signal, weight=1.0
        )
