...
class TestCompositePortfolio:
    ...
    @pytest.fixture
    def sample_signal_components(
        self, ma_crossover_signal, momentum_signal, buy_hold_signal
    ):
    ...
    def test_basic_creation(self, sample_signal_components):
        ...
        portfolio = CompositePortfolio(
            name="test_portfolio", components=sample_signal_components, weight=1.0
        )
    ...
    def test_component_management(self, sample_signal_components):
        ...
        assert len(portfolio.component_list) == len(
    ...
    def test_signal_generation(self, sample_prices, sample_signal_components):
        ...
        portfolio = CompositePortfolio(
            name="signal_test", components=sample_signal_components, weight=1.0
        )
    ...
    def test_return_calculation(self, sample_prices, sample_signal_components):
        ...
        portfolio = CompositePortfolio(
            name="return_test", components=sample_signal_components, weight=1.0
        )
    ...
    def test_performance_metrics(self, sample_prices, sample_signal_components):
        ...
        portfolio = CompositePortfolio(
            name="metrics_test", components=sample_signal_components, weight=1.0
        )
        ...
        for component in sample_signal_components:
            ...
            component_metrics = [
                key for key in metrics.keys() if key.startswith(component_prefix)
            ]
            assert (
                len(component_metrics) > 0
            ), f"No metrics found for component {component.name}"

    def test_weight_management(self, sample_signal_components):
        """Test component weight management."""
        portfolio = CompositePortfolio(
            name="weight_test", components=sample_signal_components, weight=1.0
        )
        ...
        new_weights = {"ma_signal": 0.5, "momentum_signal": 0.3, "buy_hold_signal": 0.2}
    ...
    def test_empty_portfolio(self, sample_prices):
        ...
        empty_portfolio = CompositePortfolio(name="empty", components=[], weight=1.0)
    ...
    def test_nested_portfolios(self, sample_prices, sample_signal_components):
        ...
        assert "sub_portfolio_1_" in str(metrics) or any(
            key.startswith("sub_portfolio_1") for key in metrics.keys()
        )
    ...
    def test_print_structure(self, sample_signal_components, capfd):
        ...
        sub_portfolio = CompositePortfolio(
            name="sub_portfolio", components=sample_signal_components[:2], weight=0.7
        )
...
class TestNDimensionalPortfolioBuilder:
    ...
    def test_builder_creation(self):
        ...
        config = PortfolioBuilderConfig(
            default_weight=0.5, max_depth=5, kelly_optimization=False
        )
    ...
    def test_component_creation(self, ma_crossover_signal):
        ...
        default_component = builder.create_signal_component(
            name="default_signal", signal_func_or_name=ma_crossover_signal
        )
    ...
    def test_portfolio_creation(self, sample_signal_components):
        ...
        portfolio = builder.create_portfolio(
            name="test_portfolio", components=sample_signal_components, weight=0.8
        )
    ...
    def test_balanced_portfolio_creation(self, sample_signal_components):
        ...
        balanced_portfolio = builder.create_balanced_portfolio(
            name="balanced_test", components=sample_signal_components
        )
    ...
    def test_portfolio_validation(self, sample_signal_components):
        ...
        valid_portfolio = builder.create_portfolio(
            name="valid", components=sample_signal_components
        )
    ...
    def test_max_depth_validation(self):
        ...
        level1_component = SignalComponent(
            "level1", lambda p: pl.Series([0] * len(p)), 1.0
        )
        level1_portfolio = CompositePortfolio(
            "level1_portfolio", [level1_component]
        )  # Add another portfolio level
        level2_portfolio = CompositePortfolio("level2", [level1_portfolio])
        level3_portfolio = CompositePortfolio("level3", [level2_portfolio])
        level4_portfolio = CompositePortfolio(
            "level4", [level3_portfolio]
        )  # This should exceed max_depth
...
class TestComplexPortfolioScenarios:
    ...
    def test_three_level_portfolio(
        self, sample_prices, ma_crossover_signal, momentum_signal, buy_hold_signal
    ):
        """Test a three-level portfolio hierarchy."""
        builder = NDimensionalPortfolioBuilder()

        # Level 1: Individual signals
        signal1 = builder.create_signal_component(
            "signal1", ma_crossover_signal, weight=0.5
        )
        signal2 = builder.create_signal_component(
            "signal2", momentum_signal, weight=0.5
        )
        signal3 = builder.create_signal_component(
            "signal3", buy_hold_signal, weight=1.0
        )

        # Level 2: Sub-portfolios
        sub_portfolio_1 = builder.create_portfolio(
            "sub_port_1", [signal1, signal2], weight=0.6
        )
        sub_portfolio_2 = builder.create_portfolio("sub_port_2", [signal3], weight=0.4)

        # Level 3: Meta-portfolio
        meta_portfolio = builder.create_portfolio(
            "meta_port", [sub_portfolio_1, sub_portfolio_2]
        )
    ...
    def test_portfolio_consistency(self, sample_prices, ma_crossover_signal):
        ...
        component1 = builder.create_signal_component(
            "test", ma_crossover_signal, weight=1.0
        )
        component2 = builder.create_signal_component(
            "test", ma_crossover_signal, weight=1.0
        )
    ...
    def test_mixed_weight_portfolio(self, long_sample_prices):
        ...
        long_component = builder.create_signal_component(
            "long_signal", lambda p: pl.Series([1] * len(p)), weight=1.5  # Always long
        )
        ...
        short_component = builder.create_signal_component(
            ...
            lambda p: pl.Series(
                [1] * len(p)
            ),  # Always long signal, but negative weight
            weight=-0.5,  # Short position
        )

        mixed_portfolio = builder.create_portfolio(
            "mixed_portfolio", [long_component, short_component]
        )
    ...
    def test_portfolio_attribution(self, sample_prices, sample_signal_components):
        ...
        portfolio = CompositePortfolio(
            name="attribution_test", components=sample_signal_components, weight=1.0
        )
